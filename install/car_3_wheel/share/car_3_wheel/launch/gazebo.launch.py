...
def generate_launch_description():
    ...
    robot_name_in_model = 'ver4'


    urdf_file_name = 'ver4.urdf'
    urdf = os.path.join(
        get_package_share_directory('car_3_wheel'),
        'urdf',
        urdf_file_name
        )
    with open(urdf, 'rb') as infp:
        robot_desc = infp.read().decode('utf-8')  # Đảm bảo giải mã UTF-8 sau khi đọc dưới dạng byte
